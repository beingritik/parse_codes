            ...
            if filename.endswith('.pdf'):
                ...
                for page_number in range(2):
                    ...
                    for table_index, table_data in enumerate(tables):
                        # Combine the extracted data into a single row
                        row_data = [filename, page_number+1] + table_data.values.flatten().tolist()
